...
import studentSubscriptionRoutes from "./studentSubscription";
import teacherSubscriptionRoutes from "./teacherSubscription";
...
router.use('/teacher-subscription', teacherSubscriptionRoutes);
