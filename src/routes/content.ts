...
import { optionalAuth, requireAdminAuth, requireAnyAuth, requireAuth } from '../middleware/auth';
...
router.get('/content/user', optionalAuth, validateQuery(paginationSchema.extend({
  classId: mongoIdSchema.optional(),
  subjectId: mongoIdSchema.optional(),
  chapterId: mongoIdSchema.optional(),
  paid: z.string().optional(),
...
router.get('/content/:id', optionalAuth, validateParams(z.object({ id: mongoIdSchema })), ContentController.getContentById);
