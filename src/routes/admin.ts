...
// Parent management
router.get('/parents', requireAdminAuth, validateQuery(paginationSchema), AdminController.getParents);
router.get('/parents/:id', requireAnyAuth, validateParams(z.object({ id: mongoIdSchema })), AdminController.getParentById);
router.patch('/parents/:id', requireAnyAuth, validateParams(z.object({ id: mongoIdSchema })), AdminController.updateParent);
router.delete('/parents/:id', requireAdminAuth, validateParams(z.object({ id: mongoIdSchema })), AdminController.deleteParent);
...
// File upload
router.post('/presign', requireAnyAuth, validateBody(presignSchema), AdminController.generatePresignedUrl);
